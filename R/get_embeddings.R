...
#' Função para capturar embeddings da OpenAI
#' Aceita vetores de texto
#' @param api_key É a chave da API
#' @param texto É um vetor contendo um ou mais textos para serem transformados
#'  em embeddings
#' @param model é o modelo que será utilizado (recomenda-se `text-embedding-3-small` em 2024)
